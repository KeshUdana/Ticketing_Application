...
public class ProducerService implements Runnable {
    ...
    @Override
    public void run() {
        // Logic for producing tickets (adding tickets to the ticket pool)
        try {
            BlockingQueue<Ticket> queue = ticketPool.getTicketQueue();
            // Example of producing tickets:
            Ticket ticket = new Ticket();  // Creating a new ticket
            queue.put(ticket);  // Adds the ticket to the queue
            // Further logic for producing tickets
